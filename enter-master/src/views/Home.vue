    ...
    <div class="func_wrap">
      <div class="func_wrap_inner">
        ...
        <el-row class="func_card hidden-xs-only" type="flex">
          <el-col class="card_item animate__animated animate__flipInX" v-for="(item, index) in funcCardList"
            :key="index" :span="5">
    ...
    <div class="product_shows_wrap">
      ...
      <div class="with_center">
        <div class="bottom_img_wrap">
          <div class="bottom_img_item animate__animated animate__slideInUp" v-for="(item, index) in procardList"
            :key="index">
